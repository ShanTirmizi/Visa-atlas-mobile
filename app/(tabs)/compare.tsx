...
import { CompareCountryCardV2 } from '@/components/compare/CompareCountryCardV2';
          ...
          <>
            ...
            {aiData && !loading && (
              <>
                  ...
                  <View style={styles.highlightsRow}>
                    ...
                    <View style={[styles.highlightCol, { backgroundColor: colors.surface, borderColor: colors.line }]}>
                      <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 10 }}>
                        <Flag code={toAlpha2(selectedA!.code)} size={16} />
                    ...
                    <View style={[styles.highlightCol, { backgroundColor: colors.surface, borderColor: colors.line }]}>
                      <View style={{ flexDirection: 'row', alignItems: 'center', gap: 6, marginBottom: 10 }}>
                        <Flag code={toAlpha2(selectedB!.code)} size={16} />
                        <Text style={[Type.title14, { color: colors.ink }]} numberOfLines={1}>
                          {selectedB!.name}
                        </Text>
                      </View>
                ...
                {/* ─ Plan-a-trip CTAs ───────────────────────────────────── */}
                {selectedA && selectedB && (() => {
                  // Highlight the winner's CTA, not a fixed slot. Without this,
                  // the right-hand CTA was always coral and contradicted the
                  // TOP PICK badge whenever country A was the winner.
                  const aIsWinner = overallWinner === 'a';
                  const bIsWinner = overallWinner === 'b';
                  return (
                    <View style={styles.planRow}>
                      <Pressable
                        ...
                        style={({ pressed }) => [
                          styles.planBtn,
                          {
                            backgroundColor: aIsWinner ? colors.coral : colors.surface,
                            borderColor: aIsWinner ? colors.coral : colors.line,
                      ...
                      >
                        <Text style={[
                          Type.kickerSm,
                          { color: aIsWinner ? 'rgba(255,255,255,0.85)' : colors.inkMute, fontSize: 9 },
                        ]}>
                          PLAN
                        </Text>
                        <Text
                          style={{
                            ...
                            fontSize: 15,
                            fontWeight: '500',
                            color: aIsWinner ? '#FFFFFF' : colors.ink,
                            marginTop: 2,
                          }}
                          numberOfLines={1}
                        >
                      ...
                      <Pressable
                        ...
                        style={({ pressed }) => [
                          styles.planBtn,
                          {
                            backgroundColor: bIsWinner ? colors.coral : colors.surface,
                            borderColor: bIsWinner ? colors.coral : colors.line,
                            opacity: pressed ? 0.85 : 1,
                          },
                        ]}
                      >
                        <Text style={[
                          Type.kickerSm,
                          { color: bIsWinner ? 'rgba(255,255,255,0.85)' : colors.inkMute, fontSize: 9 },
                        ]}>
                          PLAN
                        </Text>
                        <Text
                          style={{
                            ...
                            fontSize: 15,
                            fontWeight: '500',
                            color: bIsWinner ? '#FFFFFF' : colors.ink,
                            marginTop: 2,
                          }}
                          numberOfLines={1}
                        >
