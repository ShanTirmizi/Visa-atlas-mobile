...
export default function EditPassportScreen() {
  ...
  const [selected, setSelected] = useState<string[]>(visa.passports);
  const [multiMode, setMultiMode] = useState(visa.passports.length > 1);
    ...
    >
      ...
      <View style={styles.header}>
        ...
        <Text style={[styles.subtitle, { color: colors.textSecondary }]}>
          Select up to {MAX_PASSPORTS} passports you hold
        </Text>
      </View>
