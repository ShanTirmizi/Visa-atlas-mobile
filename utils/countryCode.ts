// ISO 3166-1 alpha-3 → alpha-2 mapping. The visa/data layer uses alpha-3
// (e.g. "IND") but the Flag component (and most flag libraries) expect
// alpha-2 ("IN"). Centralising here so screens don't keep copying the map.
 ...
 *  Returns the original 2-letter code unchanged, or the first 2 chars
 *  as a last-resort fallback for unknown 3-letter codes. */
